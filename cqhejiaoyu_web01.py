...
def web_login():
    ...
    lib.emil_test2.config1.logging.info("识别结果")
    print("识别结果")
    ...
    #请输入验证码
        ...
        try:
            ...
            time.sleep(4)
            lib.emil_test2.config1.logging.info("登陆成功")
            print('登录成功')
        except:
            time.sleep(2)
        ...
        print("点击刷新")
        time.sleep(2)
        lib.emil_test2.config1.logging.info("重新处理验证码")
        print("重新处理验证码")
        web_login()
...
if __name__=='__main__':
    try:
        ...
        School_Score()
        print ('拨测执行完成')
        with open('report_{}.html'.format(lib.emil_test2.config1.now), 'w') as f:
            f.write(lib.emil_test2.config1.now)
            f.write('pass')
            print (lib.emil_test2.config1.now)
        #发送邮件
        now_data=lib.emil_test2.config1.now
        print ('report_'+now_data+'.html')
        lib.emil_test2.send_email('report_' + now_data + '.html')
        #print 'pass 邮件发送成功'
        ...
        with open('report_{}.html'.format(lib.emil_test2.config1.now), 'w') as f:
            ...
            print(lib.emil_test2.config1.now)
        #发送邮件
        error_now=lib.emil_test2.config1.now
        print ('report_'+error_now+'.html')
        lib.emil_test2.send_email('report_' + error_now + '.html')
        print (EOFError)
        print ('error 邮件发送成功')
    finally:
        driver.quit()