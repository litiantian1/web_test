...
class cqxxt_Parent(object):
    ...
    def Homewrok(self):
        #查看家庭作业
        driver.find_element_by_xpath("//android.widget.GridView[@resource-id='com.aspirecn.xiaoxuntongParent.cq:id/main_funcs_gv']/android.widget.RelativeLayout[1]/android.widget.RelativeLayout[1]").click()
    ...
    def Schoolnotice(self):
        #查看学校通知
        driver.find_element_by_xpath("//android.widget.GridView[@resource-id='com.aspirecn.xiaoxuntongParent.cq:id/main_funcs_gv']/android.widget.RelativeLayout[2]/android.widget.RelativeLayout[1]").click()
        driver.find_element_by_xpath("//android.widget.ListView[@resource-id='com.aspirecn.xiaoxuntongParent.cq:id/data_listview']/android.widget.HorizontalScrollView[1]/android.widget.LinearLayout[1]/android.widget.LinearLayout[1]").click()
        time.sleep(1)
        driver.find_element_by_id('com.aspirecn.xiaoxuntongParent.cq:id/left_btn').click()
        time.sleep(2)
        driver.find_element_by_id('com.aspirecn.xiaoxuntongParent.cq:id/left_btn').click()#返回首页
    def Teachevalua(self):
        #查看教师评语
        driver.find_element_by_xpath("//android.widget.GridView[@resource-id='com.aspirecn.xiaoxuntongParent.cq:id/main_funcs_gv']/android.widget.RelativeLayout[4]/android.widget.RelativeLayout[1]").click()
        time.sleep(3)
        driver.find_element_by_xpath("//android.widget.GridView[@resource-id='com.aspirecn.xiaoxuntongParent.cq:id/other_funcs_gv']/android.widget.RelativeLayout[2]/android.widget.RelativeLayout[1]").click()
        time.sleep(2)
    ...
    def Message(self):
        ...
        driver.find_element_by_id('com.aspirecn.xiaoxuntongParent.cq:id/left_btn').click()#返回首页
    def Class1(self):
        driver.find_element_by_xpath("//android.widget.GridView[@resource-id='com.aspirecn.xiaoxuntongParent.cq:id/main_funcs_gv']/android.widget.RelativeLayout[3]/android.widget.RelativeLayout[1]").click()
        time.sleep(2)
